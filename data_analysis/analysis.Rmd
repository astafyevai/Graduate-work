...
# процент угадывания состояния выше, чем случайная вероятность. подумать, как выкинуть людей, которые отвечали на всё одно состояние. или сравнить отдельно?

prop.test(247,640,p=1/27,correct=FALSE)
