...
library(ROCR)
data_adjusted$prob <- predict(object = model, type = 'response')
data_adjusted$prob = as.numeric(data_adjusted$prob)
data_adjusted$same = as.numeric(data_adjusted$same)
pred_model <- prediction(data_adjusted$prob, data_adjusted$same)
#Error in prediction(data_adjusted$prob, data_adjusted$same) : 
